from helpers.tf_compat import distr, tf, xavier_initializer
...
class SingleLayerDecoder(object):
    ...
    def __init__(self, config, is_train):
        ...
        self.initializer = xavier_initializer() # variables initializer
    ...
    def decode(self, encoder_output):
       ...
       # _logger = logging.getLogger(__name__)
        #_logger.info(print('Encoder Output GOING TO DECODER is \n', encoder_output))
