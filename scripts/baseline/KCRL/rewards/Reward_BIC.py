...
class get_Reward(object):
    ...
    def calculate_reward_single_graph(self, graph_batch, tgraph, lambda1, lambda2, lambda3):
        ...
        # Comparator: Comparison between generated adhjacency matrix and prior knowledge matrix
        # Mismatched edges calculation for a single graph 
    ...
    def update_all_scores(self, lambda1, lambda2, lambda3):
        ...
        for graph_int, score_cyc in score_cycs:
            ls.append((graph_int, (self.penalized_score(score_cyc, lambda1, lambda2, lambda3), score_cyc[0], score_cyc[1])))
