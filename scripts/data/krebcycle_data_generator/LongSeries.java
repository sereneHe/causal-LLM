...
/**
 * Use this file to generate KrebsL dataset.
 *
...
public class LongSeries {
    ...
    private static final int N_SERIES = 10;
    ...
    public static void main(String[] args) throws IOException {
        for (int i = 0; i < N_SERIES; i++) {
            ...
            final int[][] series = new int[nParticles][timeSteps];
            ...
            System.err.println("long" + seed + ".tsv");
            Files.write(Paths.get("long" + seed + ".tsv"), lines);
        }
    }
